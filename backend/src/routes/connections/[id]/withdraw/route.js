...
export async function POST(req, { params }) {
  try {
    ...
    const connection = await connectionService.updateConnectionStatus(connectionId, userId, "withdrawn");
    return ok({ connection });
  } catch (error) {
    console.error("POST /api/connections/[id]/withdraw error:", error);
